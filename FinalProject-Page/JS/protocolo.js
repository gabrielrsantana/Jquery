...
$(document).ready(function () {
    ...
    {   
        if(dark_mode == 0){
            ...
            $(".ui-widget-content").css("background","#e2d9d9d1"); /* background do fundo caixa de texto,acordion */
            ...
            $(".ui-widget-content").css("background","#ffffff"); /* background do fundo caixa de texto,acordion NORMAL*/
